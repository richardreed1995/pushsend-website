            ...
            {step === 1 && (
              <div className="bg-card rounded-3xl shadow-lg border p-6 md:p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-base text-muted-foreground">Help us personalize your experience and deliver the most relevant content</p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-3 h-12 border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-[#A8FF9E] focus:border-[#A8FF9E] bg-background"
                    >
