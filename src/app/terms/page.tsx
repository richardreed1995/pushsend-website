      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-4 pt-32 pb-20">
        <article className="prose prose-lg mx-auto text-center [&_h2]:font-bold [&_h3]:font-bold">
          ...
          <div className="text-left space-y-8 text-lg leading-relaxed px-2 md:px-8">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6">Platform Access and Security</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6">Fees and Payment</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6">Confidentiality</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6">Liability and Indemnity</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-6">Term and Termination</h2>
            ...
            <p>Either party may terminate these Terms and the service agreement immediately by giving written notice to the other party if:</p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>The other party commits a material breach which is not capable of remedy or which is capable of remedy but is not remedied within 30 days of notice requiring remedy</li>
              <li>The other party becomes insolvent or similar circumstances occur</li>
            </ul>

            <h2 className="text-2xl font-bold mt-12 mb-6">Changes to These Terms</h2>
