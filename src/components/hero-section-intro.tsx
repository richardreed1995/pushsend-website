...
export default function HeroSectionIntro() {
  return (
    <section className="relative overflow-hidden bg-background py-4 sm:py-6 lg:py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xs leading-4 sm:leading-5 text-muted-foreground mb-4 sm:mb-5 lg:mb-6 sm:text-sm lg:text-base">
